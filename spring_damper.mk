###########################################################################
## Makefile generated for Simulink model 'spring_damper'. 
## 
## Makefile     : spring_damper.mk
## Generated on : Tue Oct 17 23:29:50 2023
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/spring_damper.exe
...
COMPILER_COMMAND_FILE     = spring_damper_comp.rsp
CMD_FILE                  = spring_damper.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/spring_damper.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/spring_damper_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=spring_damper -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/spring_damper_ert_rtw/spring_damper.c

MAIN_SRC = $(START_DIR)/spring_damper_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/spring_damper_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/spring_damper_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
